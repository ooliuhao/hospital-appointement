...
export function elMenuItem (h, menu) {
  let icon = null
  if (menu.icon) icon = <i class={ `iconfont ${menu.icon}` } style="margin-right: 4px"/>
  else if (menu.iconSvg) icon = <i class={ menu.iconSvg }/>
...
export function elSubmenu (h, menu) {
  let icon = null
  if (menu.icon) icon = <i slot="title" class={ `iconfont ${menu.icon}`} style="margin-right: 4px"/>
  else if (menu.iconSvg) icon = <i slot="title" class={ menu.iconSvg }/>
